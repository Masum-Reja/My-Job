// import {
//  MapPinIcon
//  ,EnvelopeIcon,PhotoIcon,CurrencyDollarIcon,CalendarDaysIcon
...
//           </div>
//           <div>
//             <button className="text-white bg-gradient-to-r from-violet-500 to-fuchsia-500 px-36 py-3 w-100 rounded-sm font-bold absolute right-1 my-4">
//               Apply Now
//             </button>
//           </div>
//         </div>
...
//           <h3 className=" flex items-center my-2">
//             {" "}
//             <PhoneIcon className="h-6 w-6 text-gray-500 me-2" />
//             Phone: {contact_information.phone}
//           </h3>
//           <h3 className="flex items-center my-2">
//             {" "}
...
//         </div>
//         <div>
//           <button className="text-white bg-gradient-to-r from-violet-500 to-fuchsia-500 md:px-36 py-3 px-16 ml-36 rounded-sm font-bold md:absolute md:right-1 my-4">
//             Apply Now
//           </button>
//         </div>
//       </div>
...
//     const jobsApplied = JSON.parse(localStorage.getItem("jobsApplied")) || [];
...
//       </div>
//       <button
//         className="text-white bg-gradient-to-r from-violet-500 to-fuchsia-500 px-36 py-3 w-100 rounded-sm font-bold absolute right-1 my-4"
